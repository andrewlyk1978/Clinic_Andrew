...
def search(request):
        ...
        if 'keywords' in request.GET:
            ...
            if keywords:
                queryset_list= queryset_list.filter(Q(description_icontains=keywords)|Q(title_icontains=keywords)|Q(doctor__name_icontains=keywords))
        ...
        if 'room_type' in request.GET:
            ...
            if room_type:
                queryset_list = queryset_list.filter(room__type_iexact=room_type)
