...
#REsigter your models here

class ListingAdminForm(forms.ModelForm):
    professsions= forms.ModelMultipleChoiceField(
...
class ListingAdmin(admin.ModelAdmin):
    list_display=('id','title','district','is_published','rooms','doctor',
        "tag_list","display_professions")
    list_display_links='id','title'
    list_filter=("doctor","services")
    list_editable='is_published','rooms'
    searPch_fields='title','district','doctor_name',"services__name","professions__name"
    list_per_page=25 
